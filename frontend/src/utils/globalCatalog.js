...
const DATA = {
    "Toyota": ["Land Cruiser", "Land Cruiser Prado", "Land Cruiser 70", "LC300", "Hilux", "Fortuner", "4Runner", "Rush", "Camry", "Corolla", "Corolla Cross", "RAV4", "Highlander", "Sequoia", "Tundra", "Tacoma", "Yaris", "Yaris Cross", "C-HR", "Avensis", "Avalon", "Sienna", "Prius", "Coaster", "Hiace", "Granvia", "Alphard", "Vellfire", "Tarago", "Previa", "Noah", "Voxy", "Harrier", "Crown", "Mark X", "FJ Cruiser", "Proace City", "Aygo", "Urban Cruiser", "bZ4X"],
